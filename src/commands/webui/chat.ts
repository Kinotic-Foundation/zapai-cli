...
import { WebUiChatStreamer } from '../../internal/webui/ChatStreamer.js';
import { FileUploader } from '../../internal/webui/FileUploader.js';
import { loadWebUiConfig } from '../../internal/state/WebUiConfig.js';
...
`;
  ...
  async run(): Promise<void> {
    ...
    const chatStreamer = new WebUiChatStreamer(webUiOptions);
